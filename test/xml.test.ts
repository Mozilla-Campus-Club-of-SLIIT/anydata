...
describe("xml", () => {
  describe("loadFile", () => {
    ...
    it("should create a StructuredData object with a valid xml file", async () => {
      ...
      assert.equal((data.data as Record<string, any>)["library"].length, 2)
  ...
  describe("from", () => {
    ...
    it("should handle CDATA sections correctly", () => {
      ...
      assert.ok(data instanceof StructuredData)
      assert.strictEqual(
        (data.data as Record<string, any>)["root"][0].item,
    ...
    it("should handle attributes with special characters", () => {
      ...
      assert.ok(data instanceof StructuredData)
      const item = (data.data as Record<string, any>)["root"][0].item
